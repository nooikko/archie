...
- **UI Library**: Chakra UI v3 (component typing, theme tokens, chakra-ui/react types)
...
4. **Cross-Agent Support**: Provide TypeScript expertise to other agents:
   ...
   - Help with proper typing of Chakra UI components and theme tokens
...
- **For design patterns**: "The /twn-design skill provides Chakra UI patterns and design tokens"
